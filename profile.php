       ...
       <form class="" action="<?php echo $username; ?>" method="post">
         <?php $profile_user_obj = new User($con, $username);
            ...
            if($userLoggedIn != $username){
              ...
              elseif ($logged_in_user_obj->didReciveRequest($username)) {
      ...
      <?php
          if($userLoggedIn != $username){
            echo '<div class="profile_info_bottom">';
                if(($logged_in_user_obj->getMutualFriends($username)) > 1)
                    echo  $logged_in_user_obj->getMutualFriends($username) . " Mutual friend" ;
                elseif(($logged_in_user_obj->getMutualFriends($username)) == 1)
                  echo  $logged_in_user_obj->getMutualFriends($username) . " Mutual friend" ;
                else
                   echo  $logged_in_user_obj->getMutualFriends($username) . " Mutual friend" ;
            echo '</div>';
        ...
        <div class="modal-dialog" >
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>This will be appear on the user's profile page and also their newsfeed for your frinds to see</p>
