  ...
  public function __construct($con, $user){
    ...
    public function getConvos()
    {
      ...
      foreach ($convos as $username ) {
        ...
        $latest_message_detail = $this->getLatestMessage($userLoggedIn, $username);

        $dots = (strlen($latest_message_detail[1]) >= 12) ? "..." : "";
        $split = str_split($latest_message_detail[1], 12);
        $split = $split[0] . $dots;  //insert ... if text in msg is grater then 12

        $return_string .= "<a href='messeges.php?u=$username'> <div class='user_found_messages'>
                          <img src='" . $user_found_obj->getProfilePic() . "'style='border-radius: 5px; margin-right:5px;'>
                          " . $user_found_obj->getFirstAndLastName() . "<br><span class='timestamp_smaller' id='gray'> " . $latest_message_detail[2] . "</span>
                          <p id='gray' style='margin: 0;'> " . $latest_message_detail[0] . $split . " </p>
                          </div>
                          </a> ";
    ...
    public function getConvosDropdown($data, $limit)
    {
      ...
      foreach ($convos as $username ) {
        ...
        $return_string .= "<a href='messeges.php?u=$username'>
