...
***********************************************************/
	...
	//Set Upload directory
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/Wire/assets/images/profile_pics';
	//Set File name
		//.md5(time()).'n'
		$file_temp_name = $profile_id.'_original.'.$type; //the temp file name
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){
		...
		//save the new cropped version
			imagejpeg($dst_r, "assets/images/profile_pics/".$finalname.".jpg", 90);
		...
		$result_path ="assets/images/profile_pics/".$finalname.".jpg";
